...
void drawYudhishthir(float xOrigin, float yOrigin, float scale);
...
void drawYudhishthir(float xOrigin, float yOrigin, float scale)
{
	...
	drawCommonBody(xOrigin, yOrigin, scale, 0);     // 1 for last scene(front of krishna), 0 for setting and 2 for when walking 
	drawHandAndCloth(xOrigin, yOrigin, scale, 0);   // 1 for last scene(front of krishna), 0 for setting and 2 for when walking
}
